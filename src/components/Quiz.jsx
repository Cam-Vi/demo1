//khi tạo copmponent viết hoa chữ cái đầu để phân biệt với các hàm.
//return phải bọc mọi thứ trong thẻ <></>
//1 componet được sử dụng nhiều lần
...
const [IsQuizEnd, setIsQuizEnded]= useState(false);
